...
class FakePokedexRepository : PokedexRepositoryApi {
    ...
    var pokemonAbilities: List<String> = emptyList()
    ...
    var pokemonAbilitiesByName: Map<String, List<String>> = emptyMap()
    ...
    override suspend fun getPokemonAbilities(nameOrId: String) = resolve(pokemonAbilitiesByName[nameOrId] ?: pokemonAbilities)
